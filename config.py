...
TEXT_CONTENT = {
    'it': {
        ...
        'nav_blog': "Diario di Bordo",
        'header_title': "SaltRiders World Tour",
        'header_subtitle': "L'incredibile itinerario 2025-2026 di GG & Paco, un'epopea via terra e mare all'insegna del bikepacking, del surf, dello slow travel e di un approccio sostenibile all'esplorazione.",
        ...
        'gg_description': "Spirito libero con una riserva inesauribile di entusiasmo (e forse un pizzico di <strong>incoscienza</strong>). GG affronta ogni sfida, anche la più assurda, con un gas che potrebbe svegliare un vulcano spento. Qualità: <strong>forza bruta, mente scaltra, instancabile</strong>. Difetti: <strong>Finirà i soldi in birra dopo due mesi</strong>.",
        'paco_alt_text': "Foto di Paco, perso per le montagne",
        'paco_name': "Paco - L'Esploratore Sagace",
        'paco_description': "Mente acuta e animo energico, Paco è l'anima organizzatrice del duo. Di cagate ne dice all'infinito, sono il suo pane quotidiano e <strong>la sua grande debolezza</strong> (chi lo conosce sa). L’adrenalina della scoperta lo guida, trasformando ogni imprevisto in… beh, in un altro imprevisto da risolvere. Qualità: <strong>Allegria, responsabilità</strong> (compito arduo di contenere GG). Difetti: <strong>Intestino debole</strong>.",
        ...
        'adventure_step5_optionA_desc': "Dai Caraibi, un passaggio 'al volo' via mare per Panama. Da lì, l'immensità del Pacifico: un'avventura di pura navigazione verso perle come le Galápagos e le isole della Polinesia Francese, affidandosi al buon cuore delle onde, dei venti e di chiunque abbia una cuccetta libera.",
        ...
        'adventure_outro': "Dimenticate le tabelle di marcia precise: questo è più un manifesto al viaggio vissuto con spirito indomito e adattamento totale, un brindisi all'imprevisto che diventa la norma, a un'esplorazione che rispetta i ritmi della natura e delle culture, e un tributo a ogni singola, strampalata, meravigliosa connessione umana. Restate sintonizzati, perché il bello deve ancora venire (e probabilmente non andrà come previsto)!",
    ...
    'en': {
        ...
        'nav_blog': "Logbook",
        'header_title': "SaltRiders World Tour",
        'header_subtitle': "GG & Paco's incredible 2025-2026 itinerary, an epic land and ocean journey of bikepacking, surf, slow travel, and a sustainable approach to exploration!",
        'protagonists_section_title': "Our (Sorta) Heroes",
        'gg_alt_text': "GG's photo, ready for adventure",
        'gg_name': "GG - The Enthusiastic Giant",
        'gg_description': "A free spirit with an endless supply of enthusiasm (and perhaps a touch of <strong>recklessness</strong>). GG tackles every challenge, no matter how absurd, with an energy that could awaken a dormant volcano. Qualities: <strong>brute force, a cunning mind, tireless</strong>. Flaws: <strong>Will run out of money for beer after two months</strong>.",
        'paco_alt_text': "Paco's Photo, lost in the mountains",
        'paco_name': "Paco - The Sagacious Explorer",
        'paco_description': "A sharp mind and an energetic soul, Paco is the duo's organizer. He talks endless nonsense—it's his daily bread and <strong>his great weakness</strong> (those who know, know). The adrenaline of discovery guides him, turning every unexpected event into... well, another unexpected event to solve. Qualities: <strong>Cheerfulness, responsibility</strong> (the tough job of containing GG). Flaws: <strong>A weak stomach</strong>.",
        ...
        'adventure_intro1': "Buckle up! GG and Paco are about to embark on an odyssey that will rewrite the rules of exploration and bikepacking... or at least, they'll try, hopefully with style. From the beating heart of Europe, these two intrepid adventurers will unleash their trusty bikes and surfboards on a land-and-sea tour de force, ready to collect exotic cultures and postcard-perfect vistas.",
        'adventure_intro2': "Our travel philosophy? More than a plan, it's a manifesto for <strong>slow travel</strong> and <strong>pushing the limits</strong>. A declaration of intent that embraces the unexpected, ingenuity, and a deep connection with places and people, prioritizing the strength of their legs and low-impact transport to move around the world, avoiding air travel as much as possible.",
        'adventure_step1_title': "Europe Express, with Champion-like Poise",
        'adventure_step1_desc': "From Milan, a kick-off accompanied by other young friends towards Grenoble, savouring the Old Continent and testing the gear.",
        'adventure_step2_title': "Epic (and Possibly Ill-Advised) Climbs",
        'adventure_step2_desc': "The arduous feat of crossing a major Alpine pass with surfboards in tow, to glide (hopefully in one piece) into Grenoble. The descent will be a true test of the boys' bike handling skills! Due to the tight schedule, it's possible the French leg will be done by bus/train because the Canaries are calling on November 1st.",
        ...
        'adventure_step4_desc': "From Las Palmas de Gran Canaria, they will try to sneak into the ARC (Atlantic Rally for Cruisers) fleet on November 23, 2025, or join other desperate souls looking for crew. The goal: to find a passage directly on the pontoons or through unlikely contacts. Ready to cross the Atlantic sailing towards Saint Lucia, probably washing dishes for the entire crossing.",
        ...
        'adventure_step5_optionB_desc': "A sea passage from the Caribbean to Ecuador will mark the beginning of a LONG cycling journey. Down the Pacific coast of South America, chasing legendary waves, crossing deserts and mountains that will test even the most stoic. An immersion into the continent's vibrant heart all the way to Chile, or until our legs give out.",
        'adventure_outro': "Forget rigid schedules: this is more a manifesto for travel lived with an indomitable spirit and total adaptation, a toast to the unexpected becoming the norm, to an exploration that respects the rhythms of nature and cultures, and a tribute to every single, quirky, wonderful human connection. Stay tuned, because the best is yet to come (and it probably won't go as planned)!",
        ...
        'map_las_palmas_popup': "Las Palmas, Gran Canaria - Ready for the ARC (or almost)", 'map_las_palmas_date': "23 Nov 25",
        ...
        'map_guayaquil_bike_popup': "Guayaquil - Pacific Bike Tour Start (and may the cycling gods help us)",
        'map_bike_pacific_tooltip': "Bike Pacific Coast (Mar - Jul 26) - Miles, sweat, and views",
